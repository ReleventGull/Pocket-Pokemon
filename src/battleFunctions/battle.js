...
function damage (pokemonAttacking, pokemonDefending, move, critical = 1) {
...
((((((2*pokemonAttacking.current_level*critical)/5)+2)* move.power * a/d)/50)+2) * STAB * Type1 * Type2 * random
